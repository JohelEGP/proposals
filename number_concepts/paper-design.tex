...
\rSec2[paper.design.concepts.num]{\cname{number}, common with, ordered}

\pnum
\cname{number} is the least constrained number concept.
Then, there are the simple \cname{common_number_with} and \cname{ordered_number}.
\begin{codeblock}
template<typename T>
...
\rSec2[paper.design.concepts.num.line]{\cname{number_line}}
...
\pnum
The operations required by refinements of \cname{number} are specified similarly.

\rSec2[paper.design.concepts.terse]{Terse}
